...
public class CopyNumberSegmentMyBatisRepositoryTest {
  ...
  public void fetchCopyNumberSegments() throws Exception {
    ...
    Assert.assertEquals(
        2,
        result0.stream().filter(seg -> "TCGA-A1-A0SB-01".equals(seg.getSampleStableId())).count());
    Assert.assertEquals(
        1,
        result0.stream().filter(seg -> "TCGA-A1-B0SO-01".equals(seg.getSampleStableId())).count());
    ...
    Assert.assertEquals(
        1,
        result2.stream().filter(seg -> "TCGA-A1-A0SB-01".equals(seg.getSampleStableId())).count());
    Assert.assertEquals(
        1,
        result2.stream().filter(seg -> "TCGA-A1-B0SO-01".equals(seg.getSampleStableId())).count());
